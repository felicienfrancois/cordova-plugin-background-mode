...
This is a fork of [a great plugin by Nathan Kerr](https://bitbucket.org/TheBosZ/cordova-plugin-run-in-background). It aims to keep up-to-date with Android changes while also providing more features.
